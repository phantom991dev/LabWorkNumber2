...
namespace LabWorkNumber4
{
    class Program
    {
        ...
        { 
            ...
            switch(result)
            {
                case 1: { Console.WriteLine("z = 1 - x/2 + x^2/6 - x^3/24 + x^4/120"); break; }
                case 2: { Console.WriteLine("z = 1 - y/2 + y^2/6 - y^3/24 + y^4/120"); break; }
                case 3: { Console.WriteLine("z = 1 - 2 + 2/6 - 3/24 + 4/120"); break; }
